...
/* Check if username is empty       Check if password is empty */
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password FROM doctor_base WHERE username = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            header("location:corona-free-dark-bootstrap-admin-template-1.0.0/template/pages/ddash/ddash_stat.html");
                        } else{
